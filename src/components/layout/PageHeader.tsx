...
interface PageHeaderProps {
  ...
  eyebrow?: string;
  actions?: ReactNode;
  /** Optional product-tour target on the title block (e.g. `ad-heading`). */
  dataTour?: string;
}

export function PageHeader({ title, description, eyebrow = "Workspace", actions, dataTour }: PageHeaderProps) {
  return (
